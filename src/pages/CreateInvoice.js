      ...
      {!showPreview && (
        <>
          <div className="page-header">
            ...
            <p className="page-subtitle">Fill in the details to create a new tax invoice</p>
          </div>
          ...
          <div className="form-section">
            <h3 className="section-title">Notes (Optional - leave blank to use default)</h3>
            <div className="form-group full-width">
              <textarea
                value={invoice.notes}
                onChange={(e) => updateInvoice({ notes: e.target.value })}
                placeholder="Leave blank to use default company notes. Enter custom notes to override."
                rows={4}
              />
            </div>
          </div>
          ...
          <div className="action-buttons">
            ...
            <button className="btn-secondary" onClick={handleCreateAndPreview}>
              Create & Preview
            </button>
          </div>
        </>
      ...
      {showPreview && (
        <div className="preview-mode">
          <div className="preview-actions">
            ...
            <button className="btn-success" onClick={() => navigate('/orders')}>
              View All Orders
            </button>
          </div>
